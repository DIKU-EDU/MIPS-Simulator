...
%	\Huge{Simulation of a MIPS machine} \\
		\vspace{0.5cm}
	\Large{A MIPS32 machine simulator}
}
...
\iffalse
\fancyhf{}
\fancyhead[L]{University of Copenhagen}
\fancyhead[R]{Jan Mezník}
\fancyhead[C]{BSc Project\\\texttt{See KUDOS Run}}
%\fancyfoot[C]{Center \leftmark}
\fi

\lhead{University of Copenhagen}
\chead{\texttt{See KUDOS Run}}
\rhead{Jan Mezník}
